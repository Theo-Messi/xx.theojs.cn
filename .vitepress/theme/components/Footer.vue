        ...
        <ul>
          <li class="mb2">
            <a
              ...
              name="Netflix"
              title="Netflix"
              href="https://doc.theovan.cn/streaming/Netflix-guide"
              >Netflix</a
            >
          </li>
          <li class="mb2">
            <a
              ...
              name="Disney+"
              title="Disney+"
              href="https://doc.theovan.cn/streaming/Disney-introduce"
              >Disney+</a
            >
          </li>
          <li class="mb2">
            <a
              ...
              href="https://doc.theovan.cn/streaming/Spotify"
              >Spotify Premium</a
            >
          </li>
          <li class="mb2">
            <a
              ...
              href="https://doc.theovan.cn/streaming/YouTube"
              >YouTube Premium</a
            >
          </li>
          <li class="mb2">
            <a
              ...
              name="Hulu"
              title="Hulu"
              href="https://doc.theovan.cn/streaming/Hulu"
              >Hulu</a
            >
          </li>
          <li class="mb2">
            <a
              ...
              name="HBO Max"
              title="HBO Max"
              href="https://doc.theovan.cn/streaming/HBO-Max"
              >HBO Max</a
            >
          </li>
        </ul>
    ...
    <div class="flex" style="display: inline-block">
      <span class="ml1">
        <a
          ...
          title="ICP备案"
        >
          <i class="fas fa-earth-americas" style="margin-right: 4px"></i
          >鄂ICP备2024060426号
        </a>
      </span>
      <span class="ml1">
        <a
          ...
          title="公安备案"
        >
          <i class="fas fa-shield" style="margin-right: 4px"></i
          >粤公网安备44200102445439号
        </a>
      </span>
    </div>
